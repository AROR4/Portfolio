...
import {
  Briefcase, Smile, Clock, Users,
  MapPin, Mountain, Bike, Compass, Dumbbell,
  BookOpen, Code, Puzzle, Smartphone,
  UtensilsCrossed, Car
} from "lucide-react";
...
const About = () => {
  ...
  return (
    <section id="about" className="bg-[#111010] text-white py-16 px-4 sm:px-8 md:px-12 lg:px-20">
      <div className="max-w-7xl mx-auto">
        {/* Header */}
        <div className="mb-12 text-center">
          <h2 className="text-3xl sm:text-4xl font-bold">Learn More About Me</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          <div className="flex justify-center">
            <img
              src={profile}
              alt="Profile"
              className="w-64 h-64 sm:w-80 sm:h-80 object-cover rounded-xl transition-transform duration-500 hover:scale-105"
            />
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm text-gray-300">
              <p><span className="text-indigo-400 font-medium">🎂 Birthday:</span> 26 August 2004</p>
              <p><span className="text-indigo-400 font-medium">🎓 Degree:</span> Undergraduate 2026</p>
              <p><span className="text-indigo-400 font-medium">🌐 Website:</span> <a href="https://raghavarora.vercel.app/" className="underline">raghavarora.vercel.app/</a></p>
              <p><span className="text-indigo-400 font-medium">📧 Email:</span> raghavarora9899@gmail.com</p>
              <p><span className="text-indigo-400 font-medium">📞 Phone:</span> +91 7988720509</p>
              <p><span className="text-indigo-400 font-medium">🌍 City:</span> Sonipat → Chennai</p>
              <p><span className="text-indigo-400 font-medium">💼 Freelance:</span> Available</p>
              <p><span className="text-indigo-400 font-medium">🧓 Age:</span> 20</p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-16">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div className="h-1 flex-1 bg-indigo-500 rounded-sm"></div>
          </div>
