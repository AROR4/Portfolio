...
const Contact = () => {
  return (
    <section id="contact" className="min-w-[calc(100vh-80px)]  py-15 px-55 bg-[#111010] text-white">
      <div className="max-w-4xl mx-auto px-6">
        ...
        >
          ...
          <button
            type="submit"
            className="bg-indigo-600 hover:bg-indigo-700 text-white font-medium px-6 py-3 rounded-full transition"
          >
            Send Message
          </button>
        </form>
